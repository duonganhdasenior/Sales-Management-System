"""
Sales Pro — Sales Management System
GUI: CustomTkinter · Dark Mode · Mint Green × Shopee Orange
...
def make_tree(parent, cols, widths=None, height=16):
    ...
    for i, c in enumerate(cols):
        ...
        tree.column(c, width=w, minwidth=50, anchor="center")
...
class OrdersPage(ctk.CTkFrame):
    ...
    def _view_items(self):
        ...
        cols   = ["ProductID", "Product Name", "Quantity", "Unit Price", "Subtotal"]
